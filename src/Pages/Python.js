  ...
  return (
    ...
    <div className="project-card">
      <div className="project-image-container">
        ...
        <div className="project-card-overlay c2">
          <div className="project-card-text">
            <h2 className="project-title">CollegeGuardian</h2>
            <p className="project-description">WebSite for College Folks</p>
            <p>HTML+CSS+JS</p>
            <a href="https://theavitw.github.io/CollageGuardia/index.html"><button className='bg-danger dd'>Website Link</button></a>

          </div>
         
        </div>
        <div className="project-card-overlay c3">
          <div className="project-card-text">
            <h2 className="project-title">Calculator </h2>
            <p className="project-description">Python Based Software </p>
            <p>PYTHON</p>
